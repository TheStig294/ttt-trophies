...
function TROPHY:Trigger()
    self:AddHook("TTTOrderedEquipment", function(ply, equipment, is_item, given_by_randomat)
        ...
        timer.Simple(0.1, function()
            ...
            -- Functionality of GetTraitorBuyable() can be found in stig_randomat_base_functions.lua and stig_randomat_client_functions.lua
            ...
            for i, equ in ipairs(unboughtEquipment) do
                ...
                local itemTable = GetEquipmentItem(ROLE_TRAITOR, item)
...
function TROPHY:Condition()
    return isfunction(GetTraitorBuyable)
end
